        ...
        dropddownMenu: function(n, e) {
            $(".dropdown-overlay").length || $(".core-nav").after('<div class="dropdown-overlay"></div>'), $(e).each(function() {
                ...
                switch (e.removeClass("open"), o.on("click", function(o) {
                    ...
                    }) : e.removeClass("open"), $.isFunction(n.onCloseDropdown) && n.onCloseDropdown()) : (n.animated ? (e.addClass("open"), i.animateCss(e.find(".core-nav-dropdown-menu").eq(0), n, n.animatedIn, !0)) : e.addClass("open"), $.isFunction(n.onOpenDropdown) && n.onOpenDropdown())), i.overlayDropdown()
                }), n.dropdownEvent) {
                    case "hover":
                        o.on("mouseenter", function(o) {
                            $(window).width() > 920 && (n.animated ? (e.addClass("open"), i.animateCss(e.find(".core-nav-dropdown-menu").eq(0), n, n.animatedIn, !0)) : e.addClass("open"), $.isFunction(n.onOpenDropdown) && n.onOpenDropdown()), i.overlayDropdown()
                        }), e.stop().on("mouseleave", function() {
                            $(window).width() > 920 && (n.animated ? i.animateCss(e.find(".core-nav-dropdown-menu").eq(0), n, n.animatedOut, !1, function() {
                                setTimeout(function() {
                                    e.removeClass("open")
                                }, 500)
                    ...
                    case "click":
                        o.on("click", function(o) {
                            ...
                            }) : e.removeClass("open"), $.isFunction(n.onCloseDropdown) && n.onCloseDropdown()) : (e.closest("li").closest("ul").find(".open").removeClass("open"), n.animated ? (e.addClass("open"), i.animateCss(e.find(".core-nav-dropdown-menu").eq(0), n, n.animatedIn, !0)) : e.addClass("open"), $.isFunction(n.onOpenDropdown) && n.onOpenDropdown())), i.overlayDropdown()
                        });
                        break;
                    case "accordion":
